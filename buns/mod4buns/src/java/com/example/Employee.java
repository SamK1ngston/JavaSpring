...
public class Employee {
    ...
    private static final int MIN_SALARY_VALUE = 500;
    private static final int MAX_SALARY_VALUE = 2000;
    private static final String PHONE_NUMBER_REGEX = "\\d{3} \\d{3}-\\d{2}-\\d{2}";
    private static final String DEFAULT_EMAIL_DOMAIN = "ya.ru";

    @Size(min = MIN_NAME_LENGTH, message = "name must be 2 or more symbols long")
    private String name;

    @NotBlank
    private String surname;

    @Min(value = MIN_SALARY_VALUE)
    @Max(value = MAX_SALARY_VALUE)
    private int salary;
    ...
    @Pattern(regexp = PHONE_NUMBER_REGEX, message = "must match XXX XXX-XX-XX")
    private String phoneNumber;

    @CheckEmail(value = DEFAULT_EMAIL_DOMAIN, message = "domain must be ya.ru")
    ...
    private void initializeLangList() {
